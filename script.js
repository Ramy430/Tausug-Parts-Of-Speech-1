...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Map button data-part to JSON file paths - PUT IT HERE
    const partToFile = {
        'ngan': 'json/ngan.json',
        'ganti': 'json/gantingan.json',
        'piil': 'json/piil.json',
    ...
    // Part of speech display names and descriptions - PUT IT HERE
    const partInfo = {
        'ngan': {
            name: 'Ngan (Nouns)',
    ...
    // loadPartOfSpeech(), displayPartOfSpeech(), generateExamplesHTML()
});
